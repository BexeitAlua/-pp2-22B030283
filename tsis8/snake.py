    ...
    def move(self, events):
        for event in events:
            if event.type == pg.KEYDOWN:
                if event.key == pg.K_a and self.destination != 'right':
                    self.dx = - self.speed
                    self.dy = 0
                    self.destination = 'left' 
                if event.key == pg.K_d and self.destination != 'left':
                    self.dx = self.speed
                    self.dy = 0
                    self.destination = 'right'
                if event.key == pg.K_w and self.destination != 'down':
                    self.dx = 0
                    self.dy = -self.speed
                    self.destination = 'up'
                if event.key == pg.K_s and self.destination != 'up':
                    self.dx = 0
                    self.dy = self.speed

...
class Enemy(pygame.sprite.Sprite):
      ...
      def move(self):
        ...
        if (self.rect.bottom > 600):
            ...
            #new enemy car created, just change coordinates
            self.rect.top = 0
            self.rect.center = (random.randint(40, SCREEN_WIDTH - 40), 0)
...
pygame.mixer.music.load("coins.mp3")
#Game Loop
while True:
    ...
    coinsText= font_small.render(str(COINS),True,BLACK)
    DISPLAYSURF.blit(coinsText,(370,10))
